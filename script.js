...
const pixel1 = document.querySelector('#pixel1');
const pixel2 = document.querySelector('#pixel2');
const pixel3 = document.querySelector('#pixel3');
const pixel4 = document.querySelector('#pixel4');
const pixel5 = document.querySelector('#pixel5');
const pixel6 = document.querySelector('#pixel6');
const pixel7 = document.querySelector('#pixel7');
const pixel8 = document.querySelector('#pixel8');
const pixel9 = document.querySelector('#pixel9');
const pixel10 = document.querySelector('#pixel10');
const pixel11 = document.querySelector('#pixel11');
const pixel12 = document.querySelector('#pixel12');
const pixel13 = document.querySelector('#pixel13');
const pixel14 = document.querySelector('#pixel14');
const pixel15 = document.querySelector('#pixel15');
const pixel16 = document.querySelector('#pixel16');
const pixel17 = document.querySelector('#pixel17');
const pixel18 = document.querySelector('#pixel18');
const pixel19 = document.querySelector('#pixel19');
const pixel20 = document.querySelector('#pixel20');
const pixel21 = document.querySelector('#pixel21');
const pixel22 = document.querySelector('#pixel22');
const pixel23 = document.querySelector('#pixel23');
const pixel24 = document.querySelector('#pixel24');
const pixel25 = document.querySelector('#pixel25');

function clickPixel1() {
  const colorToBePainted = document.querySelector('.selected').style.backgroundColor;
